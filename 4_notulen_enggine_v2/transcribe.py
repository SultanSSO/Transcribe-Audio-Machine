...
Usage:
    ...
    # transcribe audio -> auto-creates folder 01_nama_audio/ with TXT + JSON + MD
    ...
    # skip notulen MD generation
    python transcribe.py sidang.mp3 --no-md
...
Output (inside auto-folder):
    ...
    Notulen_*.md    auto-generated meeting minutes (Markdown)
...
def main():
  ...
  python transcribe.py sidang.mp3 --no-md
    ...
    parser.add_argument(
        ...
        help="Skip generating Notulen_*.md (only produce TXT + JSON)"
    )
